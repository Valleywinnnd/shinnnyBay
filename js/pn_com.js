 ...
 * @Last Modified time: 2019-06-13 11:46:31
 */
    ...
    $.extend({
        ...
        checkIdcard: function (idcard) {
            ...
            if (area[parseInt(idcard.substr(0, 2))] == null) {
                return {pass: false, tip: Errors[4]};
            }
            //身份号码位数及格式检验
            switch (idcard.length) {
                case 15:
                    ...
                    if (ereg.test(idcard)) {
                        //正确
                        return {pass: true, tip: Errors[0]};
                    } else {


                        return {pass: false, tip: Errors[2]};
                    }
                    break;
                case 18:
                    //18位身份号码检测
                    ...
                    if (ereg.test(idcard)) { //测试出生日期的合法性
                        ...
                        if (M == idcard_array[17].toLocaleLowerCase()) {
                            ...
                            return {pass: false, tip: Errors[3]};
                        }
                    } else {
                ...
                default:
                    ...
                    return {pass: false, tip: Errors[1]};
                    break;
            }
        },
